...
if __name__ == '__main__':
    ...
    up_cpu=colorMatch('up')
    right_cpu=colorMatch('right')
    front_cpu=colorMatch('front')
    down_cpu=colorMatch('down')
    left_cpu=colorMatch('left')
    back_cpu=colorMatch('back') 
    
    get_str=up_cpu+right_cpu+front_cpu+down_cpu+left_cpu+back_cpu;
